function experiment = dodge(experiment, net, target, step_size, lambda_tv, lambda_printability, momentum_coeff, max_iter, verbose, filtering, fixed_rgb_channels, move_ranges, preprocess, stop_prob)
